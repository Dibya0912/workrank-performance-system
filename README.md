...
✅ Day 12: Task Filters, Status Badges & Leaderboard Logic

Added task filtering across User & Admin views

Filters: All, Pending, In-Progress, Done

Introduced color-coded status badges for tasks:
...
Improved task UI clarity and usability
...
Implemented dynamic leaderboard logic:

Performance score calculated from completed tasks

Sorted ranking based on score (no hardcoded data)

Replaced static rank data with real computed rankings

Overall UX upgraded from demo-level to production-style interface
